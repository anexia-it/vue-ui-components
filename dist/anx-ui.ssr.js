'use strict';Object.defineProperty(exports,'__esModule',{value:true});var vuePropertyDecorator=require('vue-property-decorator'),veeValidate=require('vee-validate');require('vue-i18n');/*! *****************************************************************************
...
__decorate([
    vuePropertyDecorator.Prop({ default: "submit" })
], AnxButton.prototype, "btnType", void 0);
__decorate([
    vuePropertyDecorator.Prop({ default: "anx-button" })
], AnxButton.prototype, "className", void 0);
__decorate([
    vuePropertyDecorator.Prop({ default: "button" })
], AnxButton.prototype, "text", void 0);
__decorate([
    vuePropertyDecorator.Prop({ default: "136px" })
], AnxButton.prototype, "width", void 0);
AnxButton = __decorate([
    vuePropertyDecorator.Component({})
], AnxButton);
var script$1 = AnxButton;/* script */
...
__decorate([
    vuePropertyDecorator.Prop({ default: "h1" })
], AnxContent.prototype, "size", void 0);
AnxContent = __decorate([
    vuePropertyDecorator.Component({})
], AnxContent);
var script$4 = AnxContent;/* script */
...
var script$5 = AnxParagraph;/* script */
...
var script$7 = AnxCheckbox;/* script */
...
var script$8 = AnxContainer;/* script */
...
var script$9 = AnxContent$1;/* script */
...
__decorate([
    vuePropertyDecorator.Prop({ default: "anexia-logo" })
], AnxFooter.prototype, "img", void 0);
AnxFooter = __decorate([
    vuePropertyDecorator.Component({ components: { AnxIcon: __vue_component__$3 } })
], AnxFooter);
var script$a = AnxFooter;/* script */
...
__decorate([
    vuePropertyDecorator.Prop({ default: "anx-form" })
], AnxAlert$1.prototype, "name", void 0);
__decorate([
    vuePropertyDecorator.Emit("submit")
...
var script$b = AnxAlert$1;/* script */
...
var script$d = I18nLangSwitcher;/* script */
...
__decorate([
    vuePropertyDecorator.Prop({ default: "input-text-field" })
...
__decorate([
    vuePropertyDecorator.Prop({ default: "100%" })
...
__decorate([
    vuePropertyDecorator.Watch("updateInputField")
...
__decorate([
    vuePropertyDecorator.Prop({ default: "TITLE" })
...
var script$h = AnxReadonly;/* script */
...
__decorate([
    vuePropertyDecorator.Prop({ default: "anx-select-choice" })
], AnxSelect.prototype, "id", void 0);
__decorate([
    vuePropertyDecorator.Prop({ default: "Auswahl treffen" })
...
__decorate([
    vuePropertyDecorator.Watch("selected", { immediate: false })
...
var script$k = AnxTableRow;/* script */
...
var script$l = AnxTableCol;/* script */
...
var script$m = AnxTable$1;/* script */
...
__decorate([
    vuePropertyDecorator.Prop({ default: "anx-textarea" })
], AnxTextarea.prototype, "id", void 0);
__decorate([
    vuePropertyDecorator.Prop({ default: "Additional Text" })
...
__decorate([
    vuePropertyDecorator.Prop({ default: "required" })
...
var script$n = AnxTextarea;/* script */
...
};exports.Components=Components;exports.default=UIPlugin;//# sourceMappingURL=anx-ui.ssr.js.map
